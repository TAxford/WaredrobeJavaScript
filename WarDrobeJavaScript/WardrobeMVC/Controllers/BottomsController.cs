...
namespace WardrobeMVC.Controllers
{
    public class BottomsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BottomsID,BottomName,Color,Season,Occasion,Type,Photo")] Bottom bottom)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BottomsID,BottomName,Color,Season,Occasion,Type,Photo")] Bottom bottom)
        {
            if (ModelState.IsValid)
            {
